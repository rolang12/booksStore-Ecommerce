                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input name="name" value="{{ old('name') }}" required autocomplete="name"
                                        autofocus type="text" class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Name">
                                    @error('name')
                                ...
                                <div id="userlas_name-field" class="field-wrapper input">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-user">
                                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                    ...
                                    <input name="last_name" required autocomplete="last_name" autofocus type="text"
                                ...
                                <div id="address-field" class="field-wrapper input">
                                    ...
                                    <input name="address" value="{{ old('address') }}" required autocomplete="address"
                                        autofocus type="text"
                                ...
                                <div id="phone-field" class="field-wrapper input">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1
                                        2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                                    </svg>
                                    <input maxlength=" 10" name="phone" value="{{ old('phone') }}" required
                                        autocomplete="name" autofocus type="number"
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    ...
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary" value="submit">Get
                                            Started!</button>
                                    </div>
                                </div>
