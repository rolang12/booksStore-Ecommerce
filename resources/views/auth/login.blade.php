...
<body class="form">
    ...
    <div class="form-container">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log In to <a href="index.html"><span
                                    class="brand-name">BOOKS</span></a></h1>
                            ...
                            <div class="form">
                                ...
                                <div class="field-wrapper text-center keep-logged-in">
                                    <div class="n-chk new-checkbox checkbox-outline-primary">
                                        <label for="remember" class="new-control new-checkbox checkbox-outline-primary">
                        ...
                        <p class="terms-conditions">© 2020 All Rights Reserved. <a href="index.html">BOOKS</a> is a
        ...
        <div class="form-image">
            <img class="img-fluid" src="{{ asset('assets/img/book1.png') }}" alt="">
            {{-- <div class="l-image"> --}}
        </div>
    </div>
    </div>
